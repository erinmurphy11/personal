...
![Initial aquaponics system sketch](./sketch.webp)
...
![Setting up the shelf](./rack.webp)
...
![Drilling a hole for drainage](./drill.webp)
...
![Male and female PVC adaptors](./male-female.webp)
...
![Sealing the drainage hole](./silicon.webp)
...
![PVC with drainage holes drilled](./pvc.webp)
...
![Drainage pipe placed and clay added](./drain.webp)
...
![Setup with some water](./setup.webp)
...
![Initial photo of basil plants](./basil.webp)
...
<video controls muted playsinline preload="metadata">
  <source src={shrimp} type="video/mp4" />
  Your browser does not support embedded videos.
</video>
...
![Herbs in a grow bed](./herbs.webp)
...
![Aquatic plants in the tank](./real_plants.webp)
